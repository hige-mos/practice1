...
(function (global, factory) {
  ...
  function prvwidth() {
    ...
    //this.privateHandleWidth = this.$on.width();
    this.privateHandleWidth = this.$on.outerWidth();
    //this.privateLabelWidth = this.$label.width();
    this.privateLabelWidth = this.$label.outerWidth();
    this.$container.width(this.privateHandleWidth * 2 + this.privateLabelWidth);
	//console.log('handle: ',this.privateHandleWidth ,' label:',this.privateLabelWidth);
	//console.log('container: ',this.privateHandleWidth * 2 + this.privateLabelWidth);
	//console.log('wrapper: ',this.privateHandleWidth  + this.privateLabelWidth);
